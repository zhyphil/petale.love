...
export async function sendOrderConfirmation({
  ...
  return resend.emails.send({
    from: `petale <${FROM_EMAIL}>`,
    to: email,
    subject: 'Vos 50 portraits petale sont prêts 🎨',
    html: `
      <div style="font-family: Inter, system-ui, sans-serif; max-width: 560px; margin: 0 auto; padding: 32px 24px; color: #2e1810;">
        ...
        <p style="font-size: 16px; line-height: 1.6;">
          Vos 50 portraits haute définition sont prêts. <strong>Un seul clic pour tout télécharger</strong> dans un fichier ZIP.
        ...
        <div style="margin: 32px 0; text-align: center;">
          ...
          <p style="font-size: 12px; color: #834626; margin-top: 12px;">
            50 portraits · haute définition · libres de droits
          </p>
        </div>

        <p style="font-size: 14px; color: #834626; margin-top: 32px;">
          Pour toute question, écrivez à <a href="mailto:customer@petale.love" style="color: #c87838;">customer@petale.love</a>, on vous répond sous 24h.
        </p>
